...
Griffin: Created the SQL Select Statements for the 1, 4, 7, and 10 questions from the requirements. Created a baseline file.py that had just the static queries, and would accept a single parameter.
